...
def dynamic_prog_caloric_max(items, budget=100, print_table=False):
    ...
    return T[items_amount][budget]


if __name__ == "__main__":
    result = dynamic_prog_caloric_max(FOOD_ITEMS, 100, True)
    print("*" * 60)
    print("Dynamic programming caloric maximisation task solving")
    print("-" * 60)
    print(f"Maximum calories amount is {result}")
    print("Food items: pepsi, cola, potato, pizza")
    print("*" * 60)
